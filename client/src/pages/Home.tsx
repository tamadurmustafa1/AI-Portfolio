...
const storage = {
  profile: asset("profile-cover_fbae9d8d.png"),
  gameFish: asset("fish-bead-thumbnail_ed5c0dda.png"),
  hajjPoster: asset("poster-hajj-kaaba_cb371364.png"),
  bookPosters: {
    alphabet: asset("poster-alphabet-children-book_be3a79e8.png"),
    talaMoon: asset("poster-tala-moon-story_fa22dd3d.png"),
  },
  interactivePosters: {
    plant: asset("poster-save-my-plant_f0c1aa89.png"),
    cells: asset("poster-living-cells_964cbad2.png"),
    pascal: asset("poster-pascals-law_f045ca62.png"),
  },
  transVideo: asset("video-transformation-cinematic_63a0e148.mp4"),
  transPoster: asset("poster-transformation_c4c730c4.jpg"),
  images: {
    library: asset("gallery-library_2e098d0f.jpg"),
    ocean: asset("gallery-ocean-street_fee15af3.jpg"),
    dinosaur: asset("gallery-dinosaur_92c26d31.png"),
    surreal: asset("gallery-surreal_867ef0b0.jpg"),
    character1: asset("gallery-character-1_6d88aee3.jpeg"),
    character2: asset("gallery-character-2_6d0237f6.jpeg"),
    flow1: asset("gallery-flow-1_3a2b0cb7.png"),
    flow2: asset("gallery-flow-2_c7ef9063.png"),
    paperback: asset("gallery-paperback_858f1860.png"),
    construction: asset("gallery-construction_bbc1ad1a.jpg"),
    fashion: asset("gallery-fashion-card_163ca1bb.jpg"),
    computerFlow: asset("gallery-computer-flow_aaa11103.jpg"),
  },
  posters: {
    kitchen: asset("poster-kitchen_9c7f1526.jpg"),
    bead: asset("poster-bead-workshop_15ce120c.jpg"),
    lab: asset("poster-computer-lab_ba33e1d6.jpg"),
    robot: asset("poster-robot_f20c6208.jpg"),
    smartbox: asset("poster-smartbox_63373bd9.jpg"),
    cake: asset("poster-tala-cake_cbd03009.jpg"),
    promo: asset("poster-creative-promo_ae886c36.png"),
    data: asset("poster-data-trainer_5a5157bb.png"),
    smartDeliveryBox: asset("poster-smart-delivery-box_9aa9e333.png"),
    dragon: asset("poster-dragon-snow_7fedd24f.png"),
    coffee: asset("poster-tala-coffee_ec9808e5.png"),
    startup: asset("poster-computer-startup_66662812.png"),
  },
  videos: {
    kitchen: asset("video-kitchen-transformation_80d5dbcc.mp4"),
    bead: asset("video-bead-workshop-transformation_2bfd07d2.mp4"),
    lab: asset("video-computer-lab_e2d81777.mp4"),
    promo: asset("video-promo-creative_2efbcc40.mp4"),
    data: asset("video-data-trainer_d998b3c3.mp4"),
    smartbox: asset("video-smartbox-avatar_a61ff939.mp4"),
    robot: asset("video-robot-child_da506183.mp4"),
    cake: asset("video-tala-cake_4f534e8c.mp4"),
    coffee: asset("video-tala-mila-coffee_15cf5fe0.mp4"),
    dragon: asset("video-dragon-snow_533c8bab.mp4"),
    startup: asset("video-computer-startup_df1f2c15.mp4"),
  },
  html: {
    plant: asset("interactive-save-my-plant_cd281502.html"),
    cells: asset("interactive-cell-lesson_f2ece2df.html"),
    pascal: asset("interactive-pascal_9102ab6d.html"),
    beadGame: asset("game-bead-quest_f5c00ec8.html"),
    fishGame: asset("game-fish-out-of-place_338dc80f.html"),
  },
  audio: {
    courtyard: asset("Courtyard_of_the_Brave_1d7369fc.mp3"),
  },
};
