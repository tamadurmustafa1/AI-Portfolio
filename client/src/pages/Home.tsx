  ...
  return (
    <article className={`project-card type-${project.type} ${project.featured ? "featured" : ""}`}>
      <div className="project-media">
        ...
        {project.type === "html" && project.id === "fish-game" && <div className="game-art game-fish" role="img" aria-label={lang === "ar" ? "صورة مصغرة للعبة سمكة مش بمكانها" : "Thumbnail for the Fish Out of Place game"}><div className="water-light" /><span className="bubble bubble-1" /><span className="bubble bubble-2" /><span className="bubble bubble-3" /><svg className="fish-illustration" viewBox="0 0 240 140" aria-hidden="true"><path d="M67 77c18-28 54-34 82-16l28-22-4 28c15 10 15 28 0 38l4 28-28-22c-28 18-64 12-82-16H39l-18-18 18-18h28Z" fill="none" stroke="currentColor" strokeWidth="5" strokeLinejoin="round"/><circle cx="105" cy="69" r="4" fill="currentColor"/><path d="M133 57c-7 14-7 28 0 42M153 61c-5 11-5 22 0 33" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round"/></svg><div className="game-thumb-label"><Gamepad2 size={14} />{lang === "ar" ? "السمكة مش بمكانها" : "FISH OUT OF PLACE"}</div></div>}
